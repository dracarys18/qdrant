...
| max_indexing_threads | [uint64](#uint64) | optional | Number of parallel threads used for background index building. If 0 - automatically select from 8 to 16. Best to keep between 8 and 16 to prevent likelyhood of building broken/inefficient HNSW graphs. On small CPUs, less threads are used. |
